    ...
    <main class="main-content">
        <section class="hero-about">
            <div class="container">
                ...
                <p>Somos el motor que impulsa la vida nocturna en Venezuela, conectando pasión por la fiesta con experiencias inolvidables. En Rumbero Extremo, creemos que cada noche es una oportunidad para crear recuerdos únicos y vivir al máximo.</p>
            </div>
        </section>
        ...
        <section class="container purpose-section">
            ...
            <div class="purpose-cards-grid">
                <div class="purpose-card">
                    ...
                    <p>Brindar una plataforma que facilite la búsqueda de lugares para salir y conocer, transformando la experiencia social al conectar a los usuarios con los mejores eventos y lugares de entretenimiento en la ciudad.</p>
                </div>
                <div class="purpose-card">
                    <i class="fa-solid fa-eye"></i>
                    <h3>Nuestra Visión</h3>
                    <p>Ofrecer a un target adulto contemporáneo la única opción de una aplicación que reúne los locales y lugares en tendencia, ofreciendo diversión con descuentos. -Aspiramos a ser la aplicación líder en la movida del entretenimiento, fomentando una comunidad vibrante y activa, que promueve locales y espacios más exclusivos y brindando diferentes alternativas.</p>
                </div>
                <div class="purpose-card">
                    <i class="fa-solid fa-handshake"></i>
                    <h3>¿Qué Ofrecemos?</h3>
                    <p><strong>Para locales afiliados:</strong> Incremento en la captación del público y mayor afluencia referido por Rumbero Extremo.</p>
                    <p><strong>Para afiliados:</strong> Uso de la app para optar por los descuentos mediante la aplicación código QR en los diferentes aliados comerciales.</p>
                </div>
            </div>
        </section>
