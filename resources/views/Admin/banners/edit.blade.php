    ...
    <div class="allies-header-bar">
        <div class="header-content">
            ...
            <div class="page-subtitle">
                ...
                <span>Actualiza los detalles del banner y la imagen si es necesario</span>
            </div>
        </div>
        <div class="header-actions">
            <div class="user-greeting">
                <i class="fas fa-images"></i>
                <span>Editando: <strong>{{ $banner->title }}</strong></span>
            </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="full-width">
                        <div class="form-group">
                            <label for="image">
                                Imagen del Banner 
                                <span class="optional-badge">Dejar en blanco para mantener la actual</span>
                            </label>
                            <input type="file" 
                                   name="image" 
                                   id="image" 
