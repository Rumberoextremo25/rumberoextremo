...
@section('content')
    <div class="main-content">
        <div class="form-card-container">
            <h2 class="form-title"><i class="fas fa-image"></i> Crear Nuevo Banner</h2>
            <p class="form-subtitle">Sube una imagen y completa los detalles para crear un nuevo banner.</p>
            ...
            <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" placeholder="Ej: Nueva Colección Verano"
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" name="target_url" id="target_url"
                            placeholder="Ej: https://tutienda.com/nuevacoleccion" value="{{ old('target_url') }}">
                        @error('target_url')
                            <span class="error-message"><i class="fas fa-exclamation-circle"></i> {{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="order" id="order"
                            placeholder="Ej: 1 (Número para ordenar la visualización)" value="{{ old('order', 0) }}">
                        @error('order')
                            <span class="error-message"><i class="fas fa-exclamation-circle"></i> {{ $message }}</span>
                        @enderror
                    </div>
