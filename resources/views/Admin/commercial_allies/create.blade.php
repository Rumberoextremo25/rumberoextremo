        ...
        <div class="table-container">
            <div class="table-responsive" style="padding: 2rem;">
                <form action="{{ route('admin.commercial-allies.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.5rem;">
                        ...
                        <div style="grid-column: span 2 / span 2;">
                            <div class="form-group">
                                <label for="name"
                                    style="display: block; margin-bottom: 0.5rem; font-weight: 600; color: #1e293b;">
                                    Nombre del Aliado <span style="color: #ef4444;">*</span>
                                </label>
                                <input type="text" name="name" id="name"
                                    placeholder="Ej: Tienda Deportiva El Gol" value="{{ old('name') }}" required
                                    style="width: 100%; padding: 0.8rem 1rem; border: 1px solid #e2e8f0; border-radius: 12px; font-size: 0.95rem; background: #f8fafc;">
                                @error('name')
                                    <span
                                        style="color: #ef4444; font-size: 0.85rem; margin-top: 0.3rem; display: flex; align-items: center; gap: 0.3rem;">
                        ...
                        <div>
                            <div class="form-group">
                                ...
                                <input type="number" step="0.1" min="0" max="5" name="rating"
                                    id="rating" placeholder="Ej: 4.5" value="{{ old('rating', 0.0) }}"
                                    style="width: 100%; padding: 0.8rem 1rem; border: 1px solid #e2e8f0; border-radius: 12px; font-size: 0.95rem; background: #f8fafc;">
                                @error('rating')
                                    <span
                                        style="color: #ef4444; font-size: 0.85rem; margin-top: 0.3rem; display: flex; align-items: center; gap: 0.3rem;">
                        ...
                        <div>
                            <div class="form-group">
                                ...
                                <div id="logo-preview-container"
                                    ...
                                    <p style="margin-bottom: 0.5rem; color: #64748b; font-size: 0.9rem;">Previsualización:
                                    </p>
                        ...
                        <div style="grid-column: span 2 / span 2;">
                            <div class="form-group">
                                ...
                                <input type="url" name="website_url" id="website_url"
                                    placeholder="https://www.ejemplo.com" value="{{ old('website_url') }}"
                                    style="width: 100%; padding: 0.8rem 1rem; border: 1px solid #e2e8f0; border-radius: 12px; font-size: 0.95rem; background: #f8fafc;">
                                @error('website_url')
                                    <span
                                        style="color: #ef4444; font-size: 0.85rem; margin-top: 0.3rem; display: flex; align-items: center; gap: 0.3rem;">
                    ...
                    {{-- Botones de acción --}}
                    <div
                        style="display: flex; justify-content: flex-end; gap: 1rem; margin-top: 2rem; padding-top: 1.5rem; border-top: 1px solid #e9eef2;">
