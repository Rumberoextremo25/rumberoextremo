    ...
    <div class="form-container">
        ...
        <form id="editAllyForm" action="{{ route('aliados.update', $ally->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="category_name" name="category_name" placeholder="Ej: Restaurante, Bar, Tienda"
                        value="{{ old('category_name', $ally->category ? $ally->category->name : '') }}" required>
                    @error('category_name')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="business_type_name" name="business_type_name" placeholder="Ej: Físico, Online, Híbrido"
                        value="{{ old('business_type_name', $ally->businessType ? $ally->businessType->name : '') }}" required>
                ...
                {{-- ESTADO DEL ALIADO (Ya estaba bien) --}}
                <div class="form-group">
            ...
            <div class="button-group">
                <button type="button" class="cancel-btn" id="cancelEditAlly" data-index-route="{{ route('aliados.index') }}">
