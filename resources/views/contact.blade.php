    ...
    <section class="google-map-section">
        <div class="container">
            ...
            <div class="map-container">
                {{-- Replace 'YOUR_GOOGLE_MAPS_EMBED_URL' with your actual Google Maps embed iframe code --}}
                <iframe
...
@push('scripts')
    ...
    {{-- You will need to add your Google Maps API key here if you use the JS API --}}
